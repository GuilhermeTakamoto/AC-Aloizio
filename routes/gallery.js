...
module.exports = (app) => {
    ...
    app. get('/alterar_gallery' ,async(req,res)=>{
        //recuperar id da barra de endereço
        var id = req.query.id
    ...
    //alterar a imagem selecionada
           app.post('/alterar_gallery', (req, res) => {
            ...
            upload(req, res, async(err) => {
                ...
                //visualizar a imagem que será ecluida
        ...
        app.post('/excluir-gallery',async(req,res)=>{
